    ...
    net.pb = (function() {
        ...
        pb.Log = (function() {
            ...
            Log.decode = function decode(reader, length) {
                ...
                let end = length === undefined ? reader.len : reader.pos + length, message = new Log();
            ...
            Log.Record = (function() {
                ...
                Record.decode = function decode(reader, length) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    let end = length === undefined ? reader.len : reader.pos + length, message = new Log.Record();
                    while (reader.pos < end) {
                        let tag = reader.uint32();
                        switch (tag >>> 3) {
                        case 1: {
                ...
                Record.fromObject = function fromObject(object) {
                    if (object instanceof Log.Record)
                        return object;
                    let message = new Log.Record();
        ...
        pb.GetLogsRequest = (function() {
            ...
            GetLogsRequest.encode = function encode(message, writer) {
                ...
                if (message.body != null && Object.hasOwnProperty.call(message, "body"))
                    GetLogsRequest.Body.encode(message.body, writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
                return writer;
            };
            ...
            GetLogsRequest.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new GetLogsRequest();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 2: {
                            message.body = GetLogsRequest.Body.decode(reader, reader.uint32());
                            break;
                        }
                    default:
                        reader.skipType(tag & 7);
            ...
            GetLogsRequest.verify = function verify(message) {
                ...
                if (message.body != null && message.hasOwnProperty("body")) {
                    let error = GetLogsRequest.Body.verify(message.body);
                    if (error)
                        return "body." + error;
                }
                return null;
            ...
            GetLogsRequest.fromObject = function fromObject(object) {
                if (object instanceof GetLogsRequest)
                    return object;
                let message = new GetLogsRequest();
                if (object.body != null) {
                    if (typeof object.body !== "object")
                        throw TypeError(".net.pb.GetLogsRequest.body: object expected");
                    message.body = GetLogsRequest.Body.fromObject(object.body);
                }
                return message;
            };
            ...
            GetLogsRequest.toObject = function toObject(message, options) {
                ...
                if (options.defaults)
                    object.body = null;
                if (message.body != null && message.hasOwnProperty("body"))
                    object.body = GetLogsRequest.Body.toObject(message.body, options);
                return object;
            };
            ...
            GetLogsRequest.Body = (function() {
                ...
                Body.decode = function decode(reader, length) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    let end = length === undefined ? reader.len : reader.pos + length, message = new GetLogsRequest.Body();
                    while (reader.pos < end) {
                        let tag = reader.uint32();
                        switch (tag >>> 3) {
                        case 1: {
                ...
                Body.fromObject = function fromObject(object) {
                    if (object instanceof GetLogsRequest.Body)
                        return object;
                    let message = new GetLogsRequest.Body();
        ...
        pb.GetLogsReply = (function() {
            ...
            GetLogsReply.encode = function encode(message, writer) {
                ...
                if (message.logs != null && message.logs.length)
                    for (let i = 0; i < message.logs.length; ++i)
                        pb.Log.encode(message.logs[i], writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
                return writer;
            };
            ...
            GetLogsReply.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new GetLogsReply();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
                            if (!(message.logs && message.logs.length))
                                message.logs = [];
                            message.logs.push(pb.Log.decode(reader, reader.uint32()));
                            break;
                        }
                    default:
                        reader.skipType(tag & 7);
            ...
            GetLogsReply.verify = function verify(message) {
                ...
                if (message.logs != null && message.hasOwnProperty("logs")) {
                    ...
                    for (let i = 0; i < message.logs.length; ++i) {
                        let error = pb.Log.verify(message.logs[i]);
                        if (error)
                            return "logs." + error;
                    }
                }
            ...
            GetLogsReply.fromObject = function fromObject(object) {
                if (object instanceof GetLogsReply)
                    return object;
                let message = new GetLogsReply();
                if (object.logs) {
                    ...
                    for (let i = 0; i < object.logs.length; ++i) {
                        ...
                        message.logs[i] = pb.Log.fromObject(object.logs[i]);
                    }
                }
                return message;
            };
            ...
            GetLogsReply.toObject = function toObject(message, options) {
                ...
                if (message.logs && message.logs.length) {
                    ...
                    for (let j = 0; j < message.logs.length; ++j)
                        object.logs[j] = pb.Log.toObject(message.logs[j], options);
                }
                return object;
            };
        ...
        pb.PushLogRequest = (function() {
            ...
            PushLogRequest.encode = function encode(message, writer) {
                if (!writer)
                    writer = $Writer.create();
                if (message.body != null && Object.hasOwnProperty.call(message, "body"))
                    PushLogRequest.Body.encode(message.body, writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
                return writer;
            };
            ...
            PushLogRequest.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new PushLogRequest();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 2: {
                            message.body = PushLogRequest.Body.decode(reader, reader.uint32());
                            break;
                        }
                    default:
                        reader.skipType(tag & 7);
            ...
            PushLogRequest.verify = function verify(message) {
                if (typeof message !== "object" || message === null)
                    return "object expected";
                if (message.body != null && message.hasOwnProperty("body")) {
                    let error = PushLogRequest.Body.verify(message.body);
                    if (error)
                        return "body." + error;
                }
                return null;
            ...
            PushLogRequest.fromObject = function fromObject(object) {
                if (object instanceof PushLogRequest)
                    return object;
                let message = new PushLogRequest();
                if (object.body != null) {
                    if (typeof object.body !== "object")
                        throw TypeError(".net.pb.PushLogRequest.body: object expected");
                    message.body = PushLogRequest.Body.fromObject(object.body);
                }
                return message;
            };
            ...
            PushLogRequest.toObject = function toObject(message, options) {
                ...
                if (options.defaults)
                    object.body = null;
                if (message.body != null && message.hasOwnProperty("body"))
                    object.body = PushLogRequest.Body.toObject(message.body, options);
                return object;
            };
            ...
            PushLogRequest.Body = (function() {
                ...
                Body.encode = function encode(message, writer) {
                    ...
                    if (message.log != null && Object.hasOwnProperty.call(message, "log"))
                        pb.Log.encode(message.log, writer.uint32(/* id 4, wireType 2 =*/34).fork()).ldelim();
                    return writer;
                };
                ...
                Body.decode = function decode(reader, length) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    let end = length === undefined ? reader.len : reader.pos + length, message = new PushLogRequest.Body();
                    while (reader.pos < end) {
                        let tag = reader.uint32();
                        switch (tag >>> 3) {
                        case 1: {
                        ...
                        case 4: {
                                message.log = pb.Log.decode(reader, reader.uint32());
                                break;
                            }
                        default:
                            reader.skipType(tag & 7);
                ...
                Body.verify = function verify(message) {
                    ...
                    if (message.log != null && message.hasOwnProperty("log")) {
                        let error = pb.Log.verify(message.log);
                        if (error)
                            return "log." + error;
                    }
                    return null;
                 ...
                 */
                Body.fromObject = function fromObject(object) {
                    if (object instanceof PushLogRequest.Body)
                        return object;
                    let message = new PushLogRequest.Body();
                    if (object.threadID != null)
                        if (typeof object.threadID === "string")
                            $util.base64.decode(object.threadID, message.threadID = $util.newBuffer($util.base64.length(object.threadID)), 0);
                        else if (object.threadID.length >= 0)
                    ...
                    if (object.log != null) {
                        ...
                        message.log = pb.Log.fromObject(object.log);
                    }
                    return message;
                };
                ...
                Body.toObject = function toObject(message, options) {
                    ...
                    if (message.log != null && message.hasOwnProperty("log"))
                        object.log = pb.Log.toObject(message.log, options);
                    return object;
                };
        ...
        pb.PushLogReply = (function() {
            ...
            PushLogReply.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new PushLogReply();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    switch (tag >>> 3) {
                    default:
            ...
            PushLogReply.fromObject = function fromObject(object) {
                if (object instanceof PushLogReply)
                    return object;
                return new PushLogReply();
            };
        ...
        pb.GetRecordsRequest = (function() {
            ...
            GetRecordsRequest.encode = function encode(message, writer) {
                if (!writer)
                    writer = $Writer.create();
                if (message.body != null && Object.hasOwnProperty.call(message, "body"))
                    GetRecordsRequest.Body.encode(message.body, writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
                return writer;
            };
            ...
            GetRecordsRequest.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new GetRecordsRequest();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 2: {
                            message.body = GetRecordsRequest.Body.decode(reader, reader.uint32());
                            break;
                        }
                    default:
                        reader.skipType(tag & 7);
            ...
            GetRecordsRequest.verify = function verify(message) {
                if (typeof message !== "object" || message === null)
                    return "object expected";
                if (message.body != null && message.hasOwnProperty("body")) {
                    let error = GetRecordsRequest.Body.verify(message.body);
                    if (error)
                        return "body." + error;
                }
                return null;
            ...
            GetRecordsRequest.fromObject = function fromObject(object) {
                if (object instanceof GetRecordsRequest)
                    return object;
                let message = new GetRecordsRequest();
                if (object.body != null) {
                    if (typeof object.body !== "object")
                        throw TypeError(".net.pb.GetRecordsRequest.body: object expected");
                    message.body = GetRecordsRequest.Body.fromObject(object.body);
                }
                return message;
            };
            ...
            GetRecordsRequest.toObject = function toObject(message, options) {
                ...
                if (options.defaults)
                    object.body = null;
                if (message.body != null && message.hasOwnProperty("body"))
                    object.body = GetRecordsRequest.Body.toObject(message.body, options);
                return object;
            };
            ...
            GetRecordsRequest.Body = (function() {
                ...
                Body.encode = function encode(message, writer) {
                    ...
                    if (message.logs != null && message.logs.length)
                        for (let i = 0; i < message.logs.length; ++i)
                            Body.LogEntry.encode(message.logs[i], writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
                    return writer;
                };
                ...
                Body.decode = function decode(reader, length) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    let end = length === undefined ? reader.len : reader.pos + length, message = new GetRecordsRequest.Body();
                    while (reader.pos < end) {
                        let tag = reader.uint32();
                        switch (tag >>> 3) {
                        case 1: {
                        ...
                        case 3: {
                                if (!(message.logs && message.logs.length))
                                    message.logs = [];
                                message.logs.push(Body.LogEntry.decode(reader, reader.uint32()));
                                break;
                            }
                        default:
                            reader.skipType(tag & 7);
                ...
                Body.verify = function verify(message) {
                    ...
                    if (message.logs != null && message.hasOwnProperty("logs")) {
                        if (!Array.isArray(message.logs))
                            return "logs: array expected";
                        for (let i = 0; i < message.logs.length; ++i) {
                            let error = Body.LogEntry.verify(message.logs[i]);
                            if (error)
                                return "logs." + error;
                        }
                    }
                ...
                Body.fromObject = function fromObject(object) {
                    ...
                    if (object.logs) {
                        ...
                        for (let i = 0; i < object.logs.length; ++i) {
                            ...
                            message.logs[i] = Body.LogEntry.fromObject(object.logs[i]);
                        }
                    }
                    return message;
                };
                ...
                Body.toObject = function toObject(message, options) {
                    ...
                    if (message.logs && message.logs.length) {
                        object.logs = [];
                        for (let j = 0; j < message.logs.length; ++j)
                            object.logs[j] = Body.LogEntry.toObject(message.logs[j], options);
                    }
                    return object;
                };
                ...
                Body.LogEntry = (function() {
                    ...
                    LogEntry.decode = function decode(reader, length) {
                        if (!(reader instanceof $Reader))
                            reader = $Reader.create(reader);
                        let end = length === undefined ? reader.len : reader.pos + length, message = new LogEntry();
                        while (reader.pos < end) {
                            let tag = reader.uint32();
                            switch (tag >>> 3) {
                            case 1: {
        ...
        pb.GetRecordsReply = (function() {
            ...
            GetRecordsReply.encode = function encode(message, writer) {
                ...
                if (message.logs != null && message.logs.length)
                    for (let i = 0; i < message.logs.length; ++i)
                        GetRecordsReply.LogEntry.encode(message.logs[i], writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
                return writer;
            };
            ...
            GetRecordsReply.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new GetRecordsReply();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
                            if (!(message.logs && message.logs.length))
                                message.logs = [];
                            message.logs.push(GetRecordsReply.LogEntry.decode(reader, reader.uint32()));
                            break;
                        }
                    default:
                        reader.skipType(tag & 7);
            ...
            GetRecordsReply.verify = function verify(message) {
                ...
                if (message.logs != null && message.hasOwnProperty("logs")) {
                    if (!Array.isArray(message.logs))
                        return "logs: array expected";
                    for (let i = 0; i < message.logs.length; ++i) {
                        let error = GetRecordsReply.LogEntry.verify(message.logs[i]);
                        if (error)
                            return "logs." + error;
                    }
                }
            ...
            GetRecordsReply.fromObject = function fromObject(object) {
                if (object instanceof GetRecordsReply)
                    return object;
                let message = new GetRecordsReply();
                if (object.logs) {
                    if (!Array.isArray(object.logs))
                    ...
                    for (let i = 0; i < object.logs.length; ++i) {
                        ...
                        message.logs[i] = GetRecordsReply.LogEntry.fromObject(object.logs[i]);
                    }
                }
                return message;
            };
            ...
            GetRecordsReply.toObject = function toObject(message, options) {
                ...
                if (message.logs && message.logs.length) {
                    object.logs = [];
                    for (let j = 0; j < message.logs.length; ++j)
                        object.logs[j] = GetRecordsReply.LogEntry.toObject(message.logs[j], options);
                }
                return object;
            };
            ...
            GetRecordsReply.LogEntry = (function() {
                 ...
                 * @interface ILogEntry
                 * @property {Uint8Array|null} [logID] LogEntry logID
                 * @property {Array.<net.pb.pb.Log.IRecord>|null} [records] LogEntry records
                ...
                /**
                 * LogEntry records.
                 * @member {Array.<net.pb.pb.Log.IRecord>} records
                 * @memberof net.pb.GetRecordsReply.LogEntry
                 * @instance
                 */
                ...
                LogEntry.encode = function encode(message, writer) {
                    ...
                    if (message.records != null && message.records.length)
                        for (let i = 0; i < message.records.length; ++i)
                            pb.Log.Record.encode(message.records[i], writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
                    if (message.log != null && Object.hasOwnProperty.call(message, "log"))
                        pb.Log.encode(message.log, writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
                    return writer;
                };
                ...
                LogEntry.decode = function decode(reader, length) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    let end = length === undefined ? reader.len : reader.pos + length, message = new GetRecordsReply.LogEntry();
                    while (reader.pos < end) {
                        let tag = reader.uint32();
                        switch (tag >>> 3) {
                        case 1: {
                        ...
                        case 2: {
                                if (!(message.records && message.records.length))
                                    message.records = [];
                                message.records.push(pb.Log.Record.decode(reader, reader.uint32()));
                                break;
                            }
                        case 3: {
                                message.log = pb.Log.decode(reader, reader.uint32());
                ...
                LogEntry.verify = function verify(message) {
                    ...
                    if (message.records != null && message.hasOwnProperty("records")) {
                        ...
                        for (let i = 0; i < message.records.length; ++i) {
                            let error = pb.Log.Record.verify(message.records[i]);
                            if (error)
                 ...
                 */
                LogEntry.fromObject = function fromObject(object) {
                    if (object instanceof GetRecordsReply.LogEntry)
                        return object;
                    let message = new GetRecordsReply.LogEntry();
                    if (object.logID != null)
                        if (typeof object.logID === "string")
                            $util.base64.decode(object.logID, message.logID = $util.newBuffer($util.base64.length(object.logID)), 0);
                        else if (object.logID.length >= 0)
                    ...
                    if (object.records) {
                        ...
                        for (let i = 0; i < object.records.length; ++i) {
                            ...
                            message.records[i] = pb.Log.Record.fromObject(object.records[i]);
                        }
                    }
                    if (object.log != null) {
                        if (typeof object.log !== "object")
                ...
                LogEntry.toObject = function toObject(message, options) {
                    ...
                    if (message.records && message.records.length) {
                        ...
                        for (let j = 0; j < message.records.length; ++j)
                            object.records[j] = pb.Log.Record.toObject(message.records[j], options);
                    }
                    if (message.log != null && message.hasOwnProperty("log"))
                        object.log = pb.Log.toObject(message.log, options);
                    return object;
        ...
        pb.PushRecordRequest = (function() {
            ...
            PushRecordRequest.encode = function encode(message, writer) {
                if (!writer)
                    writer = $Writer.create();
                if (message.body != null && Object.hasOwnProperty.call(message, "body"))
                    PushRecordRequest.Body.encode(message.body, writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
                if (message.counter != null && Object.hasOwnProperty.call(message, "counter"))
            ...
            PushRecordRequest.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new PushRecordRequest();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 2: {
                            message.body = PushRecordRequest.Body.decode(reader, reader.uint32());
                            break;
                        }
                    case 3: {
                            message.counter = reader.int64();
            ...
            PushRecordRequest.verify = function verify(message) {
                if (typeof message !== "object" || message === null)
                    return "object expected";
                if (message.body != null && message.hasOwnProperty("body")) {
                    let error = PushRecordRequest.Body.verify(message.body);
                    if (error)
                        return "body." + error;
                }
                if (message.counter != null && message.hasOwnProperty("counter"))
            ...
            PushRecordRequest.fromObject = function fromObject(object) {
                if (object instanceof PushRecordRequest)
                    return object;
                let message = new PushRecordRequest();
                if (object.body != null) {
                    if (typeof object.body !== "object")
                        throw TypeError(".net.pb.PushRecordRequest.body: object expected");
                    message.body = PushRecordRequest.Body.fromObject(object.body);
                }
                if (object.counter != null)
                    if ($util.Long)
                        (message.counter = $util.Long.fromValue(object.counter)).unsigned = false;
            ...
            PushRecordRequest.toObject = function toObject(message, options) {
                ...
                if (message.body != null && message.hasOwnProperty("body"))
                    object.body = PushRecordRequest.Body.toObject(message.body, options);
                if (message.counter != null && message.hasOwnProperty("counter"))
                    if (typeof message.counter === "number")
                        object.counter = options.longs === String ? String(message.counter) : message.counter;
                    else
            ...
            PushRecordRequest.Body = (function() {
                 ...
                 * @property {net.pb.pb.Log.IRecord|null} [record] Body record
                 */
                ...
                /**
                 * Body record.
                 * @member {net.pb.pb.Log.IRecord|null|undefined} record
                 * @memberof net.pb.PushRecordRequest.Body
                 * @instance
                 */
                ...
                Body.encode = function encode(message, writer) {
                    ...
                    if (message.record != null && Object.hasOwnProperty.call(message, "record"))
                        pb.Log.Record.encode(message.record, writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
                    return writer;
                };
                ...
                Body.decode = function decode(reader, length) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    let end = length === undefined ? reader.len : reader.pos + length, message = new PushRecordRequest.Body();
                    while (reader.pos < end) {
                        let tag = reader.uint32();
                        switch (tag >>> 3) {
                        case 1: {
                        ...
                        case 3: {
                                message.record = pb.Log.Record.decode(reader, reader.uint32());
                                break;
                            }
                        default:
                            reader.skipType(tag & 7);
                ...
                Body.verify = function verify(message) {
                    ...
                    if (message.record != null && message.hasOwnProperty("record")) {
                        let error = pb.Log.Record.verify(message.record);
                        if (error)
                            return "record." + error;
                    }
                    return null;
                 ...
                 */
                Body.fromObject = function fromObject(object) {
                    if (object instanceof PushRecordRequest.Body)
                        return object;
                    let message = new PushRecordRequest.Body();
                    if (object.threadID != null)
                        if (typeof object.threadID === "string")
                            $util.base64.decode(object.threadID, message.threadID = $util.newBuffer($util.base64.length(object.threadID)), 0);
                        else if (object.threadID.length >= 0)
                    ...
                    if (object.record != null) {
                        ...
                        message.record = pb.Log.Record.fromObject(object.record);
                    }
                    return message;
                };
                ...
                Body.toObject = function toObject(message, options) {
                    ...
                    if (message.logID != null && message.hasOwnProperty("logID"))
                        object.logID = options.bytes === String ? $util.base64.encode(message.logID, 0, message.logID.length) : options.bytes === Array ? Array.prototype.slice.call(message.logID) : message.logID;
                    if (message.record != null && message.hasOwnProperty("record"))
                        object.record = pb.Log.Record.toObject(message.record, options);
                    return object;
                };
        ...
        pb.PushRecordReply = (function() {
            ...
            PushRecordReply.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new PushRecordReply();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    switch (tag >>> 3) {
                    default:
            ...
            PushRecordReply.fromObject = function fromObject(object) {
                if (object instanceof PushRecordReply)
                    return object;
                return new PushRecordReply();
            };
        ...
        pb.ExchangeEdgesRequest = (function() {
            ...
            ExchangeEdgesRequest.encode = function encode(message, writer) {
                if (!writer)
                    writer = $Writer.create();
                if (message.body != null && Object.hasOwnProperty.call(message, "body"))
                    ExchangeEdgesRequest.Body.encode(message.body, writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
                return writer;
            };
            ...
            ExchangeEdgesRequest.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new ExchangeEdgesRequest();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 2: {
                            message.body = ExchangeEdgesRequest.Body.decode(reader, reader.uint32());
                            break;
                        }
                    default:
                        reader.skipType(tag & 7);
            ...
            ExchangeEdgesRequest.verify = function verify(message) {
                if (typeof message !== "object" || message === null)
                    return "object expected";
                if (message.body != null && message.hasOwnProperty("body")) {
                    let error = ExchangeEdgesRequest.Body.verify(message.body);
                    if (error)
                        return "body." + error;
                }
                return null;
            ...
            ExchangeEdgesRequest.fromObject = function fromObject(object) {
                if (object instanceof ExchangeEdgesRequest)
                    return object;
                let message = new ExchangeEdgesRequest();
                if (object.body != null) {
                    if (typeof object.body !== "object")
                        throw TypeError(".net.pb.ExchangeEdgesRequest.body: object expected");
                    message.body = ExchangeEdgesRequest.Body.fromObject(object.body);
                }
                return message;
            };
            ...
            ExchangeEdgesRequest.toObject = function toObject(message, options) {
                ...
                if (options.defaults)
                    object.body = null;
                if (message.body != null && message.hasOwnProperty("body"))
                    object.body = ExchangeEdgesRequest.Body.toObject(message.body, options);
                return object;
            };
            ...
            ExchangeEdgesRequest.Body = (function() {
                ...
                Body.encode = function encode(message, writer) {
                    ...
                    if (message.threads != null && message.threads.length)
                        for (let i = 0; i < message.threads.length; ++i)
                            ExchangeEdgesRequest.Body.ThreadEntry.encode(message.threads[i], writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
                    return writer;
                };
                ...
                Body.decode = function decode(reader, length) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    let end = length === undefined ? reader.len : reader.pos + length, message = new ExchangeEdgesRequest.Body();
                    while (reader.pos < end) {
                        let tag = reader.uint32();
                        switch (tag >>> 3) {
                        case 1: {
                                if (!(message.threads && message.threads.length))
                                    message.threads = [];
                                message.threads.push(ExchangeEdgesRequest.Body.ThreadEntry.decode(reader, reader.uint32()));
                                break;
                            }
                        default:
                            reader.skipType(tag & 7);
                ...
                Body.verify = function verify(message) {
                    ...
                    if (message.threads != null && message.hasOwnProperty("threads")) {
                        ...
                        for (let i = 0; i < message.threads.length; ++i) {
                            let error = ExchangeEdgesRequest.Body.ThreadEntry.verify(message.threads[i]);
                            if (error)
                 ...
                 */
                Body.fromObject = function fromObject(object) {
                    if (object instanceof ExchangeEdgesRequest.Body)
                        return object;
                    let message = new ExchangeEdgesRequest.Body();
                    if (object.threads) {
                        ...
                        for (let i = 0; i < object.threads.length; ++i) {
                            ...
                            message.threads[i] = ExchangeEdgesRequest.Body.ThreadEntry.fromObject(object.threads[i]);
                        }
                    }
                    return message;
                };
                ...
                Body.toObject = function toObject(message, options) {
                    ...
                    if (message.threads && message.threads.length) {
                        ...
                        for (let j = 0; j < message.threads.length; ++j)
                            object.threads[j] = ExchangeEdgesRequest.Body.ThreadEntry.toObject(message.threads[j], options);
                    }
                    return object;
                };
                ...
                Body.ThreadEntry = (function() {
                    ...
                    ThreadEntry.decode = function decode(reader, length) {
                        if (!(reader instanceof $Reader))
                            reader = $Reader.create(reader);
                        let end = length === undefined ? reader.len : reader.pos + length, message = new ExchangeEdgesRequest.Body.ThreadEntry();
                        while (reader.pos < end) {
                            let tag = reader.uint32();
                            switch (tag >>> 3) {
                            case 1: {
                    ...
                    ThreadEntry.fromObject = function fromObject(object) {
                        if (object instanceof ExchangeEdgesRequest.Body.ThreadEntry)
                            return object;
                        let message = new ExchangeEdgesRequest.Body.ThreadEntry();
                        if (object.threadID != null)
                            if (typeof object.threadID === "string")
                                $util.base64.decode(object.threadID, message.threadID = $util.newBuffer($util.base64.length(object.threadID)), 0);
                            else if (object.threadID.length >= 0)
        ...
        pb.ExchangeEdgesReply = (function() {
            ...
            ExchangeEdgesReply.encode = function encode(message, writer) {
                ...
                if (message.edges != null && message.edges.length)
                    for (let i = 0; i < message.edges.length; ++i)
                        ExchangeEdgesReply.ThreadEdges.encode(message.edges[i], writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
                return writer;
            };
            ...
            ExchangeEdgesReply.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new ExchangeEdgesReply();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
                            if (!(message.edges && message.edges.length))
                                message.edges = [];
                            message.edges.push(ExchangeEdgesReply.ThreadEdges.decode(reader, reader.uint32()));
                            break;
                        }
                    default:
                        reader.skipType(tag & 7);
            ...
            ExchangeEdgesReply.verify = function verify(message) {
                ...
                if (message.edges != null && message.hasOwnProperty("edges")) {
                    ...
                    for (let i = 0; i < message.edges.length; ++i) {
                        let error = ExchangeEdgesReply.ThreadEdges.verify(message.edges[i]);
                        if (error)
                            return "edges." + error;
                    }
                }
            ...
            ExchangeEdgesReply.fromObject = function fromObject(object) {
                if (object instanceof ExchangeEdgesReply)
                    return object;
                let message = new ExchangeEdgesReply();
                if (object.edges) {
                    ...
                    for (let i = 0; i < object.edges.length; ++i) {
                        ...
                        message.edges[i] = ExchangeEdgesReply.ThreadEdges.fromObject(object.edges[i]);
                    }
                }
                return message;
            };
            ...
            ExchangeEdgesReply.toObject = function toObject(message, options) {
                ...
                if (message.edges && message.edges.length) {
                    ...
                    for (let j = 0; j < message.edges.length; ++j)
                        object.edges[j] = ExchangeEdgesReply.ThreadEdges.toObject(message.edges[j], options);
                }
                return object;
            };
            ...
            ExchangeEdgesReply.ThreadEdges = (function() {
                ...
                ThreadEdges.decode = function decode(reader, length) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    let end = length === undefined ? reader.len : reader.pos + length, message = new ExchangeEdgesReply.ThreadEdges();
                    while (reader.pos < end) {
                        let tag = reader.uint32();
                        switch (tag >>> 3) {
                        case 1: {
                ...
                ThreadEdges.fromObject = function fromObject(object) {
                    if (object instanceof ExchangeEdgesReply.ThreadEdges)
                        return object;
                    let message = new ExchangeEdgesReply.ThreadEdges();
                    if (object.threadID != null)
                        if (typeof object.threadID === "string")
                            $util.base64.decode(object.threadID, message.threadID = $util.newBuffer($util.base64.length(object.threadID)), 0);
                        else if (object.threadID.length >= 0)
        ...
        pb.Service = (function() {
            ...
            Object.defineProperty(Service.prototype.getLogs = function getLogs(request, callback) {
                return this.rpcCall(getLogs, pb.GetLogsRequest, pb.GetLogsReply, request, callback);
            }, "name", { value: "GetLogs" });
            ...
            Object.defineProperty(Service.prototype.pushLog = function pushLog(request, callback) {
                return this.rpcCall(pushLog, pb.PushLogRequest, pb.PushLogReply, request, callback);
            }, "name", { value: "PushLog" });
            ...
            Object.defineProperty(Service.prototype.getRecords = function getRecords(request, callback) {
                return this.rpcCall(getRecords, pb.GetRecordsRequest, pb.GetRecordsReply, request, callback);
            ...
            Object.defineProperty(Service.prototype.pushRecord = function pushRecord(request, callback) {
                return this.rpcCall(pushRecord, pb.PushRecordRequest, pb.PushRecordReply, request, callback);
            ...
            Object.defineProperty(Service.prototype.exchangeEdges = function exchangeEdges(request, callback) {
                return this.rpcCall(exchangeEdges, pb.ExchangeEdgesRequest, pb.ExchangeEdgesReply, request, callback);
